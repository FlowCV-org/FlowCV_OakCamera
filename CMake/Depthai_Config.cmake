...
if (CMAKE_BUILD_TYPE STREQUAL "Debug")
    ...
    elseif(APPLE)
        LIST(APPEND DEPTHAI_LIBS libdepthai-core.dylib)
        LIST(APPEND DEPTHAI_LIBS libdepthai-opencv.dylib)
        file(COPY "${depthai_DIR}/lib/libdepthai-core.dylib" DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/Oak_Camera/")
        file(COPY "${depthai_DIR}/lib/libdepthai-opencv.dylib" DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/Oak_Camera/")
        file(COPY "${depthai_DIR}/lib/cmake/depthai/dependencies/lib/libusb-1.0.dylib" DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/Oak_Camera/")
    else()
